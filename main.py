...
X_num = pipeline_num.fit_transform(train_data)

y_post = X_num.SalePrice.to_frame()
X_num.drop('SalePrice', axis=1, inplace=True)

pipeline_fill_scale = Pipeline([
    ('imputer', SimpleImputer(strategy='median')),
    ('scaler', RobustScaler()),
])

print(y_pre['SalePrice'].equals(y_post['SalePrice']))
